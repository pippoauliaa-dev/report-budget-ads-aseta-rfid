...
- Funnel Aseta: Leads → Meeting → Trial / Quotation → Deal Contract
...
- Recommendation per produk dengan What to improve dan fokus KPI
- Catatan atribusi revenue RFID First Luxury Singapore

## Online report

GitHub Pages: https://pippoauliaa-dev.github.io/report-budget-ads-aseta-rfid/

Data funnel dan revenue mengikuti input report sampai September 2026. Section berikutnya akan ditambahkan setelah isi dan struktur tiap section disepakati.
